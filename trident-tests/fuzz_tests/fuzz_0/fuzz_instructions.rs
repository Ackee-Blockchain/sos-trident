pub mod unauthorized_access_2_fuzz_instructions {
    ...
    pub struct InitializeAccounts {
        #[arbitrary(with = |u: &mut arbitrary::Unstructured| u.int_in_range(1..=3))]
    ...
    impl<'info> IxOps<'info> for Withdraw {
        ...
        fn check(
            ...
            if let Some(escrow_pre) = pre_ix.escrow {
                if pre_ix.receiver.key() != escrow_pre.receiver {
                    if pre_ix.receiver.lamports() < post_ix.receiver.lamports() {
